function PhoneBook() {
    ...
    this.init = function () {
        try {
            ...
            alert("phone_edit: init: " + e.message);
        }
    };
    this.getName = function () {
        try {
            ...
            alert("phone_edit: getName: " + e.message);
        }
    };
    this.updateStr = function () {
        try {
            ...
            alert("phone_edit: updateStr: " + e.message);
        }
    };
        ...
        try {
            switch (k) {
                ...
                case this.ROW.VALUE:
                    ...
                    break;
                default:
                    console.log("phone_edit: catchEdit: bad k");
                    break;
            }
        } catch (e) {
            alert("phone_edit: catchEdit: " + e.message);
        }
    };
    this.btnCntDel = function () {
        try {
            ...
            alert("phone_edit: btnCntDel: " + e.message);
        }
    };
    this.btnCntAdd = function () {
        try {
            ...
            alert("phone_edit: btnCntAdd: " + e.message);
        }
    };
    this.add = function () {
        try {
            ...
            alert("phone_edit: add: " + e.message);
        }
    };
    ...
    this.confirm = function (action, d, n) {
        try {
            ...
            alert("phone_edit: confirm: " + e.message);
        }
    };
    this.abort = function (action, m, n) {
        try {
            ...
            alert("phone_edit: abort: " + e.message);
        }
    };
    this.redrawTbl = function () {
        try {
            ...
            alert("phone_edit: redrawTbl: " + e.message);
        }
    };
    this.show = function () {
        try {
            ...
            alert("phone_edit: show: " + e.message);
        }
    };
    this.hide = function () {
        try {
            ...
            alert("phone_edit: hide: " + e.message);
        }
    };
}
var vphone_book = new PhoneBook();
visu.push(vphone_book);
